        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              boxShadow: [
                BoxShadow(
                  color: Color.fromARGB(255, 91, 64, 2).withOpacity(.2),
                  blurRadius: 32,
                  offset: Offset(40, 20),
                ),
                BoxShadow(
                  color: Color.fromARGB(19, 63, 53, 24).withOpacity(1),
                  blurRadius: 32,
                  offset: Offset(-20, -10),
                ),
              ],
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint centerCirclePaint = Paint()..color = Color.fromARGB(255, 255, 0, 0);
    ...
    Paint hourPaint = Paint()
      ..color = Color.fromARGB(255, 92, 100, 137)
      ..strokeWidth = 6
      ..strokeCap = StrokeCap.round;
